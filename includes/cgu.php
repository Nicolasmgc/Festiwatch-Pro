...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="src/Logo alternatif.png">
...
<body>
    ...
    <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par FestiWatch et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».
        ...
        Prodetech se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.
    </p>

    <h2><span>Article 1 :</span> Les mentions légales</h2>
    <p>L'édition du site FestiWatch est assurée par la Société Prodetch dont le siège social est situé au 10 Rue de Vanves, 92130 Issy-les-Moulineaux.<br>
        Numéro de téléphone : 01 49 54 52 00<br>
        Adresse mail : prodetech@gmail.com<br>
        L'hébergeur du site FestiWatch est la société Prodetech, dont le siège social est situé au 10 Rue de Vanves, 92130 Issy-les-Moulineaux, avec le numéro de téléphone : 01 49 54 52 00
    </p>

    <h2><span>Article 2 :</span> Accès au site</h2>
    <p>Le site FestiWatch permet à l'Utilisateur un accès gratuit aux services suivants : Le site internet propose les services suivants :
        ...
        Tout Utilisateur membre régulièrement inscrit pourra également solliciter sa désinscription en se rendant à la page dédiée sur son espace personnel. Celle-ci sera effective dans un délai raisonnable. Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas votre responsabilité. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.
    ...
    <h2><span>Article 3 :</span> Collecte des données</h2>
    ...
    <h2><span>Article 4 :</span> Propriété intellectuelle</h2>
    ...
    <h2><span>Article 5 :</span> Responsabilité</h2>
    <p>Les sources des informations diffusées sur le site FestiWatch sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.<br>
    ...
    <h2><span>Article 6 :</span> Liens hypertextes</h2>
    <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site FestiWatch. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.  
    </p>
